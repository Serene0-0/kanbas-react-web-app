...
export default function WorkingWithObjects() {
    ...
    return (
        ...
        <a id="wd-update-module-name"
            className="btn btn-primary float-end md-3"
            href={`${MODULE_API_URL}/name/${module.name}`}>
            Update Module Name
        </a>
        <input className="form-control w-75 md-3" id="wd-module-name"
        ...
        <a id="wd-retrieve-module-title" className="btn btn-primary me-2"
