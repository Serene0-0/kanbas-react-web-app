export default function Lab1() {
    return (
      ...
      My favorite recipe of Sichuan Boiled Beef:
      <ol id="wd-your-favorite-recipe">
         <li>Marinate the beef</li>
         <li>Prepare the vegetables</li>
         <li>Make the spicy broth</li>
         <li>Cook the beef</li>
      </ol>
      ...
      <form id="wd-text-fields">
        ...
        <input type="text" id="wd-text-fields-last-name" placeholder="Doe"
          ...
          Please
          <a id="wd-lipsum" href="https://github.com/Serene0-0/kanbas-react-web-app"> click here</a>&nbsp;
          to the code repository<br/>
      </form>
    </div>
